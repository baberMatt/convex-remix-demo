...
export default function Index() {
  return (
    <div className='flex flex-col text-center w-screen h-screen justify-center items-center bg-indigo-100'>
      <h1 className="font-bold text-5xl">Remix Convex on Vercel Demo</h1>
